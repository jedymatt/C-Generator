...
public class ConfigureTab extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jTextField1.setText(main.lib.Value.getProperty("written_work.quantity")
        );
        ...
        jTextField2.setText(main.lib.Value.getProperty("performance_task.quantity")
        );
        ...
        jTextField3.setText(main.lib.Value.getProperty("written_work.range.max")
        );
        ...
        jTextField4.setText(main.lib.Value.getProperty("performance_task.range.max")
        );
        ...
        jTextField5.setText(main.lib.Value.getProperty("quarterly_assessment.range.max")
        );
        ...
        jTextField6.setText(main.lib.Value.getProperty("written_work.range.min")
        );
        ...
        jTextField7.setText(main.lib.Value.getProperty("performance_task.range.min")
        );
        ...
        jTextField8.setText(main.lib.Value.getProperty("quarterly_assessment.range.min")
        );
        ...
        jComboBox1.setSelectedIndex(Integer.parseInt(main.lib.Value.getProperty("written_work.index.percent"))
        );
        ...
        jComboBox2.setSelectedIndex(Integer.parseInt(main.lib.Value.getProperty("performance_task.index.percent")
        ));
        ...
        jComboBox3.setSelectedIndex(Integer.parseInt(main.lib.Value.getProperty("quarterly_assessment.index.percent")
        ));
    ...
    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
        ...
        main.lib.Value.setProperty("written_work.index.percent", "" + jComboBox1.getSelectedIndex());
        main.lib.Value.setProperty("performance_task.index.percent", "" + jComboBox2.getSelectedIndex());
    ...
    private void jComboBox2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox2ActionPerformed
        ...
        main.lib.Value.setProperty("peformance_task.index.percent", "" + jComboBox2.getSelectedIndex());
        main.lib.Value.setProperty("written_work.index.percent", "" + jComboBox1.getSelectedIndex());
    ...
    private void jTextField3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextField3ActionPerformed
        // TODO add your handling code here:
        main.lib.Value.setProperty("written_work.range.max", jTextField3.getText());
    }//GEN-LAST:event_jTextField3ActionPerformed

    private void jTextField1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1KeyReleased
        // TODO add your handling code here:
        main.lib.Value.setProperty("written_work.quantity", jTextField1.getText());
    }//GEN-LAST:event_jTextField1KeyReleased

    private void jTextField2KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField2KeyReleased
        // TODO add your handling code here:
        main.lib.Value.setProperty("performance_task.quantity", jTextField2.getText());
    }//GEN-LAST:event_jTextField2KeyReleased

    private void jTextField6KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField6KeyReleased
        // TODO add your handling code here:
        main.lib.Value.setProperty("written_work.range.min", jTextField6.getText());
    ...
    private void jTextField7KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField7KeyReleased
        // TODO add your handling code here:
        main.lib.Value.setProperty("performance_task.range.min", jTextField7.getText());
    }//GEN-LAST:event_jTextField7KeyReleased

    private void jTextField4KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField4KeyReleased
        // TODO add your handling code here:
        main.lib.Value.setProperty("performance_task.range.max", jTextField4.getText());
    }//GEN-LAST:event_jTextField4KeyReleased

    private void jTextField8KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField8KeyReleased
        // TODO add your handling code here:
        main.lib.Value.setProperty("quarterly_assessment.range.min", jTextField8.getText());
    }//GEN-LAST:event_jTextField8KeyReleased

    private void jTextField5KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField5KeyReleased
        // TODO add your handling code here:
        main.lib.Value.setProperty("quarterly_assessment.range.max", jTextField5.getText());
